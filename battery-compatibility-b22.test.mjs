...
const cleanup=async()=>{await q`DELETE FROM battery_compatibility WHERE org_id=${org}`;await q`DELETE FROM battery_compatibility WHERE org_id=${other}`;await q`DELETE FROM battery_products WHERE org_id=${org}`;await q`DELETE FROM battery_products WHERE org_id=${other}`;await q`DELETE FROM organization_memberships WHERE org_id=${org}`;await q`DELETE FROM organization_memberships WHERE org_id=${other}`;await q`DELETE FROM users WHERE id=${owner}`;await q`DELETE FROM organizations WHERE id=${org}`;await q`DELETE FROM organizations WHERE id=${other}`};
