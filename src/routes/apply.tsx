  ...
  return <main className="min-h-dvh bg-canvas px-4 py-6 sm:py-10"><div className="mx-auto max-w-xl">
    ...
    <Card className="p-5 sm:p-7">
      ...
      {step===3&&<form onSubmit={submit} className="space-y-4"><Header n="3" title="Confirm your eligibility" body="Read and confirm each statement before submitting."/>
        ...
        <div className="rounded-xl bg-warning-50 p-3 text-xs leading-5 text-warning-800"><ShieldCheck className="mr-1 inline size-4"/>Submitting does not activate you for dispatch. An owner must review and approve your application, documents, Towbook link, and all compliance requirements.</div>
